 ...
 * - IMAGE STYLES UPDATED: using working config from old version (dark backgrounds, text-white, no white borders)
 */
...
const isProjectJourney =
  ...
  // ============================
  // Uploader Logic (unchanged from new version)
  // ============================
  ...
  return (
    ...
    >
      {/* ENQUIRY BACKGROUND - unchanged from working config (dark) */}
      {isEnquiry && (
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          {/* ENQUIRY SECTION - styles updated to match working config (dark backgrounds, white text) */}
          {isEnquiry ? (
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10">
                  ...
                  <section className="bg-neutral-800/70 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-white/10 shadow-2xl text-white">
                    <form onSubmit={handleEnquirySubmit} className="space-y-6">
                      ...
                      {/* Attachments - uploader logic preserved, only visual styles updated to dark theme */}
                      <div>
            ...
            // BEHIND DB SECTION - UPDATED: using working config (dark background, text-white, no white borders)
            <div
            ...
            // REMAINING SECTIONS - UPDATED: using working config (dark backgrounds, text-white, no white borders)
            <div
