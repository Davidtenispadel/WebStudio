/*
 * SECTIONVIEW.TSX — VERSIÓN CORREGIDA Y FUNCIONAL
 * - Hero solo en Architecture (opcional, puedes eliminarlo)
 * - Eliminada la sección Project Journey
 * - Formulario Enquiry completo
 * - Header con animación DB+
 */
