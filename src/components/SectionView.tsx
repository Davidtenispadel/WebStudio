...
const SectionView: React.FC<SectionViewProps> = ({
  ...
  // Estados de animación y transición
  ...
  return (
    ...
    >
      ...
      {/* HEADER con animación "DB+ volando" */}
      <div
      ...
      >
        <div className="max-w-7xl mx-auto">
          {/* SECCIÓN PROJECT JOURNEY (solo Hero) */}
          {isProjectJourney && (
          ...
          {/* RESTO DE SECCIONES (incluyendo Enquiry) */}
          {!isProjectJourney && (
            <>
              {isEnquiry ? (
                                    ...
                                    <div className="flex items-start gap-3">
                                      ...
                                      <div className="flex-1">
                                        <div className="flex items-center gap-2">
                                          ...
                                          <span className="text-[11px] text-white/50">· {formatBytes(file.size)}</span>
                                        </div>
                                      </div>
                          ...
                          {enquiryStep >= 4 && (
                            <div className="py-16 flex flex-col items-center text-center space-y-6">
                              ...
                              <div>
                                ...
                                <p className="text-white/70 mt-2">Your project details have been submitted to <span className="text-red-400">db@dbsdesigner.com</span>. We will review and contact you shortly.</p>
                              </div>
                            </div>
                          )}
                        </form>
