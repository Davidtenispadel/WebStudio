/* 
 * SECTIONVIEW.TSX — Unified Version (MODIFIED: Hero removed from Architecture section)
 * - Architecture section now only shows the descriptive block (no Hero).
 * - Hero is rendered exclusively from App.tsx when isArchitecture is true.
 */
...
// Hero ya no se importa aquí porque se renderiza desde App
...
const SectionView: React.FC<SectionViewProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* HEADER (Aesthetic A) — omitido por brevedad, pero debe estar aquí */}
      {/* ... (el código del header permanece igual) ... */}
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          {/* ARCHITECTURE SECTION: SOLO BLOQUE DESCRIPTIVO (sin Hero) */}
