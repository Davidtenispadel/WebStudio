/* 
 * SECTIONVIEW.TSX — Unified Version (HERO REMOVED)
 * - Hero is now rendered exclusively in App.tsx when the section is Architecture.
 * - Architecture section shows only the descriptive block.
 */
      ...
      >
        <div className="max-w-7xl mx-auto">
          {isArchitectureSection ? (
            // ARCHITECTURE SECTION: only the descriptive block (Hero is in App)
            ...
            <>
              ...
              {/* BEHIND DB SECTION: single image and description */}
              {isBehindDBSection && (
