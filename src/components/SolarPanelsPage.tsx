...
const SolarPanelsPage: React.FC = () => {
  return (
    <div className="text-black max-w-6xl mx-auto px-4">
      <h2 className="text-3ximport React from 'react';
import SolarPanelCalculator from './SolarPanelCalculator';
...
const SolarPanelsPage: React.FC = () => {
  return (
    <div className="text-black max-w-6xl mx-auto px-4">
      ...
      {/* ============================================================ */}
      {/* 1. ORIGINS AND EVOLUTION (sin cambios) */}
      {/* ============================================================ */}
      ...
      {/* ============================================================ */}
      {/* 2. ACTUAL SOLAR TECHNOLOGIES (nueva sección) */}
      {/* ============================================================ */}
      ...
      <h4 className="text-xl font-semibold mt-6 mb-2">3.1 The tandem revolution: Perovskite + Silicon</h4>
      ...
      <h4 className="text-xl font-semibold mt-6 mb-2">3.2 Back‑Contact (BC) technology – the premium choice for aesthetics and efficiency</h4>
      <p className="mb-2">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full border-collapse border border-gray-300 text-sm">
          <thead className="bg-gray-100">
            <tr><th className="border p-2">Month</th><th className="border p-2">Solar generation (kWh)</th><th className="border p-2">Self‑consumed (kWh)</th><th className="border p-2">Exported / Curtailed (kWh)</th><th className="border p-2">% of demand covered</th></tr>
          </thead>
          <tbody>
      ...
      {/* ============================================================ */}
      {/* 10. PERMITTED DEVELOPMENT & MCS (antes 11) */}
      {/* ============================================================ */}
      <h3 className="text-2xl font-semibold mt-10 mb-4">
      ...
      {/* ============================================================ */}
      {/* 11. INTERACTIVE CALCULATOR (antes 12) */}
      {/* ============================================================ */}
...
export default SolarPanelsPage;l md:text-4xl font-light mb-6">
        <strong>Solar panels: complete technical guide for homeowners (2025‑2026)</strong>
      </h2>
