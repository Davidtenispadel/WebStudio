...
const SolarPanelCalculator: React.FC = () => {
  ...
  const handleSaveProject = () => {
    ...
    const data = {
      ...
      totalPanelsCount,
      panelsRoofA: panelsA,
      panelsRoofB: enableRoofB ? panelsB : 0,
      totalWp,
      inverterName: `${inverterPrices[inverterType]?.name || inverterType}${dualInverter ? ' (dual)' : ''}`,
      totalInstallCost,
      totalAnnualKwh,
        ...
        <div className="mb-6">
          ...
          <div ref={barRef} className="relative h-12 w-full bg-gray-700 rounded-lg overflow-hidden cursor-pointer" onClick={(e) => {
            ...
            if (rect) {
              ...
              setSelfConsumptionPercent(Math.round(Math.min(100, Math.max(0, percent))));
            }
          }}>
