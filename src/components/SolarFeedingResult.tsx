...
// Datos de autoconsumo (puedes cambiar este valor o leerlo de un estado)
const selfConsumedKwhPerMonth = 251.1; // kWh al mes (del ejemplo real)

// Definición de los tres tipos de vivienda con su consumo mensual típico
// y una lista de los principales equipos eléctricos que pueden funcionar con esa energía.
const householdTypes = [
  {
    size: '1‑2 habitaciones',
    monthlyConsumption: 450, // kWh/mes (vivienda típica con cocina eléctrica, calefacción eléctrica, sin EV)
    appliances: [
  ...
  },
  {
    ...
    monthlyConsumption: 750, // kWh/mes
    appliances: [
  ...
  {
    size: '5+ habitaciones',
    monthlyConsumption: 1100, // kWh/mes
    appliances: [
...
const SolarFeedingResult: React.FC = () => {
  return (
    <div className="my-8 p-5 bg-white rounded-2xl border border-gray-200 shadow-md overflow-x-auto">
      <h3 className="text-xl font-semibold text-gray-800 mb-2">
        🔋 ¿Qué puedes alimentar con tu autoconsumo solar de {selfConsumedKwhPerMonth} kWh/mes?
      </h3>
              ...
              <div>
                ...
                {fraction >= 1 && (
                  <p className="text-xs text-green-600 mt-2">
                    ✅ ¡Tu autoconsumo es suficiente para esta vivienda!
                  </p>
                )}
              </div>
            </div>
